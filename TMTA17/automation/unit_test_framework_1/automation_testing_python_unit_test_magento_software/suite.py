...
from automation.curs_11_12.test_login import Test_Login
from automation.curs_11_12.test_search import Magento_login
...
class TestSuite(unittest.TestCase):
		def test_suite(self):
				...
				test_list.addTests([unittest.defaultTestLoader.loadTestsFromTestCase(Magento_login),
